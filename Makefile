...
# Generated by qmake (2.01a) (Qt 4.8.7) on: ?? 12? 19 18:46:35 2018
# Project:  painter.pro
# Template: app
# Command: d:\Qt\bin\qmake.exe -o Makefile painter.pro
#############################################################################
...
Makefile: painter.pro  ../Qt/mkspecs/win32-g++-4.6/qmake.conf ../Qt/mkspecs/features/device_config.prf \
